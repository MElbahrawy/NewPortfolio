...
const About = () => {
  return (
    <div className="flex flex-wrap-reverse sm:grid-cols-2 justify-between items-center gap-10 mb-10 sm:mb-40">
      <div className=" transition duration-300 w-3/4 sm:w-48 md:w-64 lg:w-1/4 aspect-square mx-auto shadow-lg hover:shadow-sm shadow-dark-light hover:shadow-main rounded-lg overflow-hidden">
        {" "}
        <img src={avatar} className="w-full object-cover rounded" alt="" />
      </div>
      <h1 className="w-full sm:w-1/2 text-xl sm:text-sm md:text-xl ">
        <span className="font-bold text-main text-2xl uppercase">
          Who am i?
        </span>{" "}
        <br />
